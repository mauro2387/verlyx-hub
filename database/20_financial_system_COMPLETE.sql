...
-- Incluye: company_users + sistema financiero
-- =====================================================

-- =====================================================
-- PARTE 1: TABLA COMPANY_USERS (PREREQUISITO)
-- =====================================================
...
USING (
  user_id = auth.uid() 
  OR company_id IN (
    SELECT id FROM my_companies WHERE user_id = auth.uid()
  )
);

DROP POLICY IF EXISTS "Users can manage company_users" ON company_users;
CREATE POLICY "Users can manage company_users"
...
-- Index
CREATE INDEX IF NOT EXISTS idx_categories_company ON categories(my_company_id);
...
DROP POLICY IF EXISTS "Users can create categories in their company" ON categories;
...
DROP POLICY IF EXISTS "Users can update categories in their company" ON categories;
...
DROP POLICY IF EXISTS "Users can delete categories in their company" ON categories;
...
-- Index
CREATE INDEX IF NOT EXISTS idx_accounts_company ON accounts(my_company_id);
...
DROP POLICY IF EXISTS "Users can create accounts in their company" ON accounts;
...
DROP POLICY IF EXISTS "Users can update accounts in their company" ON accounts;
...
DROP POLICY IF EXISTS "Users can delete accounts in their company" ON accounts;
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_expenses_company ON expenses(my_company_id);
...
DROP POLICY IF EXISTS "Users can create expenses in their company" ON expenses;
...
DROP POLICY IF EXISTS "Users can update expenses in their company" ON expenses;
...
DROP POLICY IF EXISTS "Users can delete expenses in their company" ON expenses;
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_incomes_company ON incomes(my_company_id);
CREATE INDEX IF NOT EXISTS idx_incomes_date ON incomes(payment_date);
...
CREATE INDEX IF NOT EXISTS idx_incomes_client ON incomes(client_id);
...
DROP POLICY IF EXISTS "Users can create incomes in their company" ON incomes;
...
DROP POLICY IF EXISTS "Users can update incomes in their company" ON incomes;
...
DROP POLICY IF EXISTS "Users can delete incomes in their company" ON incomes;
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_budgets_company ON budgets(my_company_id);
CREATE INDEX IF NOT EXISTS idx_budgets_category ON budgets(category_id);
CREATE INDEX IF NOT EXISTS idx_budgets_period ON budgets(period, year, month);
...
DROP POLICY IF EXISTS "Users can create budgets in their company" ON budgets;
...
DROP POLICY IF EXISTS "Users can update budgets in their company" ON budgets;
...
DROP POLICY IF EXISTS "Users can delete budgets in their company" ON budgets;
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_transactions_company ON transactions(my_company_id);
CREATE INDEX IF NOT EXISTS idx_transactions_account ON transactions(account_id);
CREATE INDEX IF NOT EXISTS idx_transactions_date ON transactions(transaction_date);
CREATE INDEX IF NOT EXISTS idx_transactions_expense ON transactions(expense_id);
CREATE INDEX IF NOT EXISTS idx_transactions_income ON transactions(income_id);
...
DROP POLICY IF EXISTS "Users can create transactions in their company" ON transactions;
...
-- COMMENTS
-- =====================================================
COMMENT ON TABLE company_users IS 'Relación usuario-empresa con roles y permisos';
...
-- SELECT create_default_categories('YOUR_COMPANY_ID_HERE');
-- SELECT create_default_accounts('YOUR_COMPANY_ID_HERE');
